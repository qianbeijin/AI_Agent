...
class DocumentChunk(Base):
    ...
    doc_id = Column(String, index=True, nullable=False, comment="关联的文档全局唯一ID")
    ...
    metadata_ = Column("metadata_", JSON, nullable=True) # 注意：为了避免 Python 内部冲突，有时会做个别名映射，但直接用 metadata = Column(JSON) 通常也没问题
